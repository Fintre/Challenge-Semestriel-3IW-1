...
<script>
    tinymce.init({
        ...
        width:"100%",
        plugins: 'media',
        toolbar: 'link image table mergetags',
        image_list: [
            ...
            <form method="post" action="<?= $_SERVER['REQUEST_URI'] ?>">
                ...
                <div class="post-info">
                    <div class="block-card block-card-custom-page info">
                        ...
                        <div class="block-card-custom-page-info-property">Statut<span class="block-card-custom-page-info-value"><?php echo $isPublished ? 'Publiée' : "" ?></span>
                        </div>
